        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    @else
                    <li class="nav-item">
                        <a href="{{ route('images.index') }}" class="nav-link {{ request()->is('account/images*') ? 'active' : '' }}">My Photos</a>
                    </li>
                    <li class="nav-item">
                            <a href="{{ route('favorites.index') }}" class="nav-link {{ request()->is('account/favorites*') ? 'active' : '' }}">Favorites</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('comment.index')}}" class="nav-link {{ request()->is('account/comments*') ? 'active' : '' }}">Comments</a>
                    </li>
