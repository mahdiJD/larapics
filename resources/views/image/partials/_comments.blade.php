    ...
    <x-form action="{{ route('comments.store' , $image->slug)}}">
        <div class="d-flex mt-4">
            <div class="flex-shrink-0">
                ...
                width="64" height="64" class="rounded-circle mr-3" alt="{{ auth()->user()->username }}">
            </div>
            <div class="flex-grow-1 ms-3">
                <textarea name="body" rows="3" placeholder="Write comment here"
                class="form-control mb-1 @error('body')
                is-invalid
                @enderror"></textarea>
                @error('body')
    ...
    @foreach ($comments as $comment)
        <div class="d-flex mt-4">
            <div class="flex-shrink-0">
                ...
                class="rounded-circle mr-3" width="100" height="100" alt="{{$comment->user->username}}">
            </div>
            <div class="flex-grow-1 ms-3">
