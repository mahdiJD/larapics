<x-layout totle="Account Settings">
                ...
                <div class="col-md-6">
                    <fieldset>
                        ...
                        <div class="mb-3">
                            ...
                            class="form-control @error('user.username')
                            is-invalid
                            @enderror">
                            @error('user.username')
                        ...
                        <div class="mb-3">
                            ...
                            class="form-control @error('user.name')
                            is-invalid
                            @enderror">
                            @error('user.name')
                            <div class="invalid-feedback">
                        ...
                        <div class="mb-3">
                            ...
                            class="form-control @error('user.profile_image')
                            is-invalid
                            @enderror">
                        ...
                        <div class="mb-3">
                            ...
                            class="form-control @error('user.city')
                            is-invalid
                            @enderror">
                            @error('user.city')
                            <div class="invalid-feedback">
                        ...
                        <div class="mb-3">
                            ...
                            class="form-control @error('user.country')
                            is-invalid
                            @enderror">
                            @error('user.country')
                            <div class="invalid-feedback">
                        ...
                        <div class="mb-3">
                            ...
                            @enderror
                            <textarea name="user[about_me]" id="about_me" rows="3" class="form-control"
                                placeholder="In a few words, tell us about yourself"
                                >{{old('user.country',$user->about_me)}}</textarea>
                        </div>
                    </fieldset>
                    <fieldset class="mt-3">
                        ...
                        <div class="mb-3">
                            ...
                            class="form-control @error('account.email')
                            is-invalid
                            @enderror">
                            @error('account.email')
                            <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    <fieldset>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" name="user[cover_image]" id="cover_image"
                            value="{{old('user.cover_image',$user->cover_image)}}"
                            class="form-control @error('user.cover_image')
                            is-invalid
                            @enderror">
                            @error('user.cover_image')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="checkbox"
                                    ...
                                    id="email_notification_no" value="1"
